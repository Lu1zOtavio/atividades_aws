...
const novoPost = document.createElement('arquive');
novoPost.innerHTML = <h3>${arrayPostagens[1].titulo}</h3> <p class="subtitulo">${arrayPostagens[1].subtitulo}</p> <div>${arrayPostagens[1].texto}</div>;
